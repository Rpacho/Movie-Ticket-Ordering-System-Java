...
public class Control{
    ...
    void display(){
        ...
        theView.setMovieNum(Integer.toString(index+1));
        theView.setMovieNumTotal(Integer.toString(arraySize));
        model.setVenue(filteredArray.get(index).getVenue());
        model.setRated(filteredArray.get(index).getKidRating());
    ...
    class SelectListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            try{
                ...
                Ticket ticket;
                ticket = new Ticket(theView, model);
