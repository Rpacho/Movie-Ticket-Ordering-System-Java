...
public class View extends JFrame{
	...
	void setMovieNum(String numOfMovie){
		movieNum.setText(numOfMovie);
	}
	void setMovieNumTotal(String numOfMovieTotal){
		movieTotalnum.setText(numOfMovieTotal);
	}
	...
	private void createView(){
		...
		divider = new JLabel("/");
		divider.setBounds(250,380,10,10);
		panel.add(divider);
		...
		movieNum = new JLabel();
		movieNum.setBounds(235,380,20,10);
		panel.add(movieNum);

		movieTotalnum = new JLabel();
		movieTotalnum.setBounds(260,380,20,10);
		panel.add(movieTotalnum);
